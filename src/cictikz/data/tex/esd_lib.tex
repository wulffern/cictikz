...
\newcommand{\esdDiode}[5]{%
  %- hand-drawn compact diode, house weight: the circuitikz [D] bipole
  %- is close to a transistor in size and overwhelms the network
  \draw (#1,#2) -- (#1,{#4-0.3});
  \draw ({#1-0.2},{#4-0.3}) -- ({#1+0.2},{#4-0.3})
        -- (#1,{#4+0.2}) -- ({#1-0.2},{#4-0.3});
  \draw ({#1-0.2},{#4+0.2}) -- ({#1+0.2},{#4+0.2});
  \draw (#1,{#4+0.2}) -- (#1,#3);
