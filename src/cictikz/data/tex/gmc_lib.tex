...
\newcommand{\gmcVcap}[3]{%
  \draw (#1,#2) -- (#1,{(#2+#3)/2+0.06});
  \draw ({#1-0.34},{(#2+#3)/2+0.06}) -- ({#1+0.34},{(#2+#3)/2+0.06});
  \draw ({#1-0.34},{(#2+#3)/2-0.06}) -- ({#1+0.34},{(#2+#3)/2-0.06});
  \draw (#1,{(#2+#3)/2-0.06}) -- (#1,#3);
}

% A capacitor in a horizontal run from (#1,#2) to (#3,#2).
\newcommand{\gmcHcap}[3]{%
  \draw (#1,#2) -- ({(#1+#3)/2-0.06},#2);
  \draw ({(#1+#3)/2-0.06},{#2-0.34}) -- ({(#1+#3)/2-0.06},{#2+0.34});
  \draw ({(#1+#3)/2+0.06},{#2-0.34}) -- ({(#1+#3)/2+0.06},{#2+0.34});
  \draw ({(#1+#3)/2+0.06},#2) -- (#3,#2);
}
