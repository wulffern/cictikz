...
\definecolor{toneA}{rgb}{1.00,0.00,0.00}   % first tone pair: house red
\definecolor{toneB}{rgb}{0.00,0.00,1.00}   % second tone pair: house blue
\definecolor{specfilter}{rgb}{0.00,0.00,0.00}  % filters are annotation: black
...
\newcommand{\specBand}[4]{%
  \draw[specfilter, very thick, rounded corners=3pt]
